...
## Долучитися
Чекаємо тебе у нашому дружньому ком’юніті “Вивчаємо Rust Разом”. <br/>
💬 Долучайся до [Телеграм-Чату](https://t.me/rustlang_ua) та [Телеграм-Каналу](https://t.me/rustlang_ua).<br/>
📖 Наша добірка матеріали для освоєння Rust [тут](https://github.com/Learn-Together-Pro/LearnRustTogether). 

Також шукай нас на платформах: <br/>
